...
const KNOWN_CONNECTORS: &str = "whatsapp, slack, gmail, calendar, telegram, hackernews, linkedin";
...
pub const CONNECTOR_FILTER_HELP: &str =
    "Filter by connector (slack, gmail, whatsapp, calendar, telegram, hackernews, linkedin)";
